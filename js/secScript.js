let teacher1Button = document.querySelector(".teacher1"); 
let images = document.querySelector(".images");
let teacher2Button = document.querySelector(".teacher2");
let teacher3Button = document.querySelector(".teacher3");
let teacher4Button = document.querySelector(".teacher4");
let teacher5Button = document.querySelector(".teacher5");
let teacher6Button = document.querySelector(".teacher6");
